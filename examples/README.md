...
| `model_training/builtin_arch/` | You want a built-in Llama/Qwen/OLMoE/DeepSeek/Kimi/Nemotron training workload with preset-plus-overrides dimensions. | Uploadable `DataflowProgram v1` JSON. |
