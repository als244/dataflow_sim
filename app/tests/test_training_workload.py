...
from dataflow_app.workloads.training import build_bare_training_chain, build_training_chain
...
def test_bare_chain_uses_step_accum_layer_task_ids():
    bare = build_bare_training_chain(L=2, grad_accum_rounds=2, num_steps=2)
